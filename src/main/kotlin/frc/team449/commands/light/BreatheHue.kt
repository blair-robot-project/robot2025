...
class BreatheHue(private val led: Light, private val hue: Int) : Command() {
    ...
    override fun execute() {
        for (i in LightConstants.SECTION_1_START..LightConstants.SECTION_1_END) {
            ...
            // intensity
            val intensity =
                MathUtil.inputModulus(firstIntensity1 + i * 32.5 / led.buffer.length, 125.0, 255.0)
        ...
        for (i in LightConstants.SECTION_2_START..LightConstants.SECTION_2_END) {
            ...
            val intensity =
                MathUtil.inputModulus(
                    firstIntensity2 +
                        (i - LightConstants.SECTION_2_START) * 32.5 / led.buffer.length,
                    125.0,
                    255.0,
                )
            led.setHSV(i, hue, 255, intensity.toInt())
