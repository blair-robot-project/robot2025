...
class OrbitAlign(
    ...
    override fun execute() {
        fieldToRobot = poseSubsystem.pose.translation
        ...
        val ctrlRadius =
            sqrt(ctrlX.pow(2) + ctrlY.pow(2)).pow(SwerveConstants.JOYSTICK_FILTER_ORDER)
        ...
        val rotSpeed =
            MathUtil.clamp(
                headingPID.calculate(poseSubsystem.heading.radians),
                -RobotConstants.MAX_ROT_SPEED,
                RobotConstants.MAX_ROT_SPEED,
            )

        /**
         * Quick fix for the velocity skewing towards the direction of rotation by rotating it with
         * offset proportional to how much we are rotating
         */
