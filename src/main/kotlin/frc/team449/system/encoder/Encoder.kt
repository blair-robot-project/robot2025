 ...
 *   1, not a reciprocal), e.g. this would be 70 if there were a 70:1 gearing between the encoder
...
abstract class Encoder(
    ...
    /**
     * Used to control [Encoder]s. Only one [SimController] can be used per encoder object.
     *
