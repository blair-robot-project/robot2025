 ...
 * @param timeout Maximum time to wait after trajectory has finished to get in tolerance. A very low
 *   timeout may end this command before you get in tolerance.
 */
class PIDPoseAlign(
    ...
    private val thetaController: PIDController =
        PIDController(AutoConstants.DEFAULT_ROTATION_KP, 0.0, 0.0),
    ...
    override fun isFinished(): Boolean {
        return allControllersAtReference() || timer.hasElapsed(timeout)
    }
