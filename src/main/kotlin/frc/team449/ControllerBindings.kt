...
class ControllerBindings(
    ...
    private fun pointToRight() {
        driveController
            .a()
            .onTrue(robot.driveCommand.pointAtAngleCommand(Rotation2d.fromDegrees(90.0)))
    }
    ...
    private fun characterizationExample() {
         ...
         * Example
         *
         * val exampleSubsystemRoutine = SysIdRoutine( SysIdRoutine.Config(
         * Volts.of(0.5).per(Seconds.of(1.0)), Volts.of(3.0), Seconds.of(10.0) ) { state ->
         * SignalLogger.writeString("state", state.toString()) }, Mechanism( { voltage:
         * Measure<Voltage> -> run { robot.shooter.setVoltage(voltage.`in`(Volts)) } }, null,
         * robot.shooter, "shooter" ) )
         *
         * // Quasistatic Forwards driveController.povUp().onTrue(
         * exampleSubsystemRoutine.quasistatic(SysIdRoutine.Direction.kForward) )
         *
         * // Quasistatic Reverse driveController.povDown().onTrue(
         * exampleSubsystemRoutine.quasistatic(SysIdRoutine.Direction.kReverse) )
         *
         * // Dynamic Forwards driveController.povRight().onTrue(
         * exampleSubsystemRoutine.dynamic(SysIdRoutine.Direction.kForward) )
         *
         * // Dynamic Reverse driveController.povLeft().onTrue(
