 ...
 * @param makeSidePID Used to make two copies of the same PID controller to control both sides of
 *   the robot.
...
open class DifferentialDrive(
    ...
    override fun set(desiredSpeeds: ChassisSpeeds) {
        ...
        val sideVoltages = feedForward.calculate(prevLeftVel, leftVel, prevRightVel, rightVel, 0.02)
