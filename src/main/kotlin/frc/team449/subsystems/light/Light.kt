 ...
 */
class Light(port: Int, length: Int) : SubsystemBase() {
    ...
    /** Copy the AddressableLEDBuffer setHsv() except to support GRB LED strips */
    ...
    /** Copy the AddressableLEDBuffer setRGB() except to support GRB LED strips */
    ...
    companion object {
        ...
        fun createLight(): Light {
            return Light(LightConstants.LIGHT_PORT, LightConstants.LIGHT_LENGTH)
        }
    }
}
