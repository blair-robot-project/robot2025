...
class Wrist(
  ...
  fun slowWristSpeed(): Command {
    return runOnce {
      setAccelAndVel(
        WristConstants.LOW_ACCEL,
        WristConstants.LOW_VEL
      )
    }
  }
  ...
  private fun logData() {
    ...
    DogLog.log("Wrist/Acceleration", motor.acceleration.valueAsDouble)
    DogLog.log("Wrist/Velocity", motor.velocity.valueAsDouble)
  }
